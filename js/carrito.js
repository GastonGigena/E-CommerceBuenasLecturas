...
function addToCart(id) {
    if(!data[id].itemInCart){
        ...
        alert('Cuadernillo añadido a tu carrito')

    }
    else{
        alert('El cuadernillo ya está en el carrito')
    }
...
function addItem(){
    ...
    var clrNode=document.getElementById('item-body');
        ...
        document.getElementById('total-amount').innerHTML = 'Costo Total: $ '+ totalAmount;
        document.getElementById('total-items').innerHTML = 'cuadernillos: ' + totalItems;
